...
After training for around 100,000 iterations one gets some such as the following. On my MacBook Pro this takes around one hour to complete.
...
This file is [Literate Haskell Markdown](https://github.com/sol/markdown-unlit). Use `ghci -pgmL markdown-unlit PrimesNN.lhs` to run.
