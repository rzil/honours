...
weighted_example = WeightedGraph (buildGraphFromEdges [("g",("x","v")),("e",("v","u")), ("f",("u","w"))]) (M.fromList [("e",2),("f",1),("g",1)])

unweighted_equivalent_example :: Graph String String
unweighted_equivalent_example = (buildGraphFromEdges [("e1",("u","v")), ("e2",("u","v")), ("f",("w","u")),("g",("x","v"))])
